...
namespace Sencilla.Infrastructure.SqlMapper.Mapping.Impl.Table
{
    public partial class TableMapping<TEntity> : ITableMapping<TEntity> where TEntity : class, new()
    {
        ...
        private IColumnMapping<TEntity> GetColumnMapping(PropertyInfo property, Type type, string name, string fieldName, bool canBeNull)
        {
            ...
            {
                return canBeNull
                    ? (IColumnMapping<TEntity>)new ColumnUIntNullMapping<TEntity>(this, property, name, fieldName)
                    : (IColumnMapping<TEntity>)new ColumnUIntMapping<TEntity>(this, property, name, fieldName);
            }
            ...
            {
                return canBeNull
                    ? (IColumnMapping<TEntity>)new ColumnULongNullMapping<TEntity>(this, property, name, fieldName)
                    : (IColumnMapping<TEntity>)new ColumnULongMapping<TEntity>(this, property, name, fieldName);
            }
